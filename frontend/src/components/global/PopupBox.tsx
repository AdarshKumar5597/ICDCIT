...
const PopupBox = ({
  ...
  return (
    <AnimatePresence>
      ...
      >
        <div
          className={`flex flex-col w-full h-full text-gray-700 dark:text-darkText-400 z-20 opacity-100 md:p-4 p-4 bg-blue-300 rounded-md shadow-sm dark:bg-darkBox-900 dark:border-darkBorder-800 mx-auto relative`}
        >
          {!disabledTopBar && (
            <div
          ...
          <div
            className={`flex flex-col no-scrollbar overflow-y-hidden`}
          >
            {children}
          </div>
        </div>
